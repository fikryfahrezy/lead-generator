/**
 * From: https://github.com/lucia-auth/example-nextjs-google-oauth/blob/main/lib/server/rate-limit.ts
 */
export class TokenBucket<TKey> {
  public max: number;
  ...
  public check(key: TKey, cost: number): boolean {
